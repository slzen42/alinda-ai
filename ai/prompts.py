...
(One sentence on the pattern between them — how they interact under stress, \
how they repair, what the core tension seems to be.)
...
def build_session_summary_prompt(
    ...
    Args:
        ...
        conversation_text:   The full conversation formatted as a readable transcript.
                             Format each line as: "Name: message content"
